...
my_name = "Robert Gordon Willhoft"
...
print( name_length )
# EXTRA ...
print( paste( my_name, "has", name_length, "characters" ) )
print( paste( "'", my_name, "' has ", name_length, " characters", sep='' ) )
...
# original variable
fav_1 <- fav_1 / sqrt(101)
fav_2 <- fav_2 / sqrt(101)
